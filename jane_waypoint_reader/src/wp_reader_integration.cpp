...
bool file_die=false;
int wp_size =0;
bool request_wp(jane_ui::linenumin_waypointout::Request &req,jane_ui::linenumin_waypointout::Response &res){
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "jane_waypoint_reader");
  ros::NodeHandle nh;
  string filepath;
  nh.getParam("/jane_ui/wp_file_path",filepath);
