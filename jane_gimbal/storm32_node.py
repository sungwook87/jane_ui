...
from jane_ui.msg import JaneGimbalOrientation
...
def gimbal_euler_callback(msg):
    ...
    """
#    quaternion = (msg.euler_orientation.x, msg.euler_orientation.y, msg.euler_orientation.z,
#                  msg.orientation.w)
    euler = (msg.euler_orientation.x, msg.euler_orientation.y, msg.euler_orientation.z)
...
#                msg.quaternion.w = q[3]
                msg.vector.x = euler[0]
                msg.vector.y = euler[1]
                msg.vector.z = euler[2]
                pub.publish(msg)
...
if __name__ == "__main__":
    ...
    if version:
        ...
        sub = rospy.Subscriber(
            "~target_orientation",
            JaneGimbalOrientation,
            gimbal_euler_callback,
            queue_size=1)
...
#            "~controller_orientation", QuaternionStamped, queue_size=1)
        camera_pub = rospy.Publisher(
            "~camera_orientation", Vector3Stamped, queue_size=1)
        controller_pub = rospy.Publisher(
            "~controller_orientation", Vector3Stamped, queue_size=1)
